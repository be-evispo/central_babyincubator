function charts2() {
    ...
    setInterval(function () {
        var x = (new Date()).getTime(),
            y = parseFloat(document.getElementById("cSskin2").innerHTML);
    ...
    setInterval(function () {
        var x2 = (new Date()).getTime(),
            y2 = parseFloat(document.getElementById("cSchamber2").innerHTML);
        //console.log(this.responseText);
    ...
    setInterval(function () {
        var x3 = (new Date()).getTime(),
            y3 = parseFloat(document.getElementById("chumadity2").innerHTML);
        //console.log(this.responseText);
    ...
    setInterval(function () {
        var x4 = (new Date()).getTime(),
            y4 = parseFloat(document.getElementById("cnoise2").innerHTML);
        //console.log(this.responseText);
