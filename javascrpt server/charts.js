function charts() {
    ...
    setInterval(function () {
        var x = (new Date()).getTime(),
            y = parseFloat(document.getElementById("cSskin").innerHTML);
    ...
    setInterval(function () {
        var x2 = (new Date()).getTime(),
            y2 = parseFloat(document.getElementById("cSchamber").innerHTML);
        //console.log(this.responseText);
    ...
    setInterval(function () {
        var x3 = (new Date()).getTime(),
            y3 = parseFloat(document.getElementById("chumadity").innerHTML);
        //console.log(this.responseText);
    ...
    setInterval(function () {
        var x4 = (new Date()).getTime(),
            y4 = parseFloat(document.getElementById("cnoise").innerHTML);
        //console.log(this.responseText);
